...
<head>
	...
	<link href="<?php echo base_url(); ?>css/VidyoConnector.css" rel="stylesheet" type="text/css" >

	<!-- Here we load the application which knows how to
	invoke the VidyoConnector API. -->
	<script src="<?php echo base_url(); ?>js/VidyoConnector.js"></script>
			...
			function (participants) {
				...
				if (participants) {
					participants.forEach(function (each) {
						$("#mediaBridgeParticipantList").append("<li class='mediaBridgeParticipantList'><img src='<?php echo base_url(); ?>img/Images/checkmark.svg'/>&nbsp;&nbsp;" + each.name + "</li>");
					});
				}
			}
		);
...
<?php
	...
	if($result->num_rows()>0){$row=$result->row();
?>
...
<body id="vidyoConnector">
	...
	<button id="optionsVisibilityButton" title="Toggle Options" class="optionsVisibiliyButtonElements
	hideOptions hidden"></button>

	<div id="options" class="options hidden">
		<img class="logo" src="<?php echo base_url(); ?>img/Images/VidyoIcon.png"/>
		...
		<p>
			...
			<label>Token</label>
			<input type="text" id="token" class="token" placeholder="ACCESS-TOKEN" value="<?php echo $row->token; ?>">
		</p>
		<p>
			<!-- This is the display name that other users will see.
			-->
			<label for="displayName">Display Name</label>
			<input id="displayName" class="displayName" type="text" placeholder="Display Name" value="<?php echo $this->session->userdata('username'); ?>">
		</p>
		<p>
			...
			<input id="resourceId" class="resourceId" type="text" placeholder="Conference Reference" value="<?php echo $row->room_id; ?>">
		</p>
		</div>
		<p>
	...
	<div id="helper">
		<table>
			<tr>
				<td><img class="logo" src="<?php echo base_url(); ?>img/Images/VidyoIO-LogoHorizontal-Dark@2x.png"/></td>
			</tr>
			<tr>
						...
						<tr>
							<td id="joinViaBrowser" class="hidden">
								<div class="helperHeader">
									<img src="<?php echo base_url(); ?>img/Images/web.svg" onclick="javascript:joinViaBrowser()"/>
								</div>
								<ul>
									<li class="helperCheck"><img src="<?php echo base_url(); ?>img/Images/checkmark.svg"/>&nbsp;&nbsp;
										Join immediately
									</li>
									<li class="helperCheck"><img src="<?php echo base_url(); ?>img/Images/checkmark.svg"/>&nbsp;&nbsp;
										No install
							...
							<td id="joinViaPlugIn" class="hidden">
								<div class="helperHeader">
									<img src="<?php echo base_url(); ?>img/Images/download.svg" onclick="javascript:joinViaPlugIn()"/>
								</div>
								<ul>
									<li class="helperCheck"><img src="<?php echo base_url(); ?>img/Images/checkmark.svg"/>&nbsp;&nbsp;
							...
							<td id="joinViaApp" class="hidden">
								<div class="helperHeader">
									<img src="<?php echo base_url(); ?>img/Images/desktop.svg" onclick="javascript:joinViaApp()"/>
								</div>
								<ul>
									<li class="helperCheck"><img src="<?php echo base_url(); ?>img/Images/checkmark.svg"/>&nbsp;&nbsp;
										Join with a click
							...
							<td id="joinViaOtherApp" class="hidden">
								<div class="helperHeader">
									<img src="<?php echo base_url(); ?>img/Images/download.svg" onclick="javascript:joinViaOtherApp()"/>
								</div>
								<ul>
									<li class="helperCheck"><img src="<?php echo base_url(); ?>img/Images/checkmark.svg"/>&nbsp;&nbsp;
							...
							<td id="joinViaMediaBridge" class="hidden">
								<div class="helperHeader">
									<img src="<?php echo base_url(); ?>img/Images/mediaBridge.svg" id="dialimage" onclick="javascript:joinViaMediaBridge()"/>
								</div>
								<ul>
									<li class="helperCheck"><img src="<?php echo base_url(); ?>img/Images/checkmark.svg"/>&nbsp;&nbsp;
										Join from a phone
			...
			<tr id="helperPlugIn" class="hidden">
				<td>
					<div class="helperHeader">
						<img src="<?php echo base_url(); ?>img/Images/download.svg" onclick="javascript:joinViaBrowser()"/>
					</div>
					<ul>
						<li class="helperCheck"><img src="<?php echo base_url(); ?>img/Images/checkmark.svg"/>&nbsp;&nbsp;
			...
			<tr id="helperApp" class="hidden">
				<td>
					<div class="helperHeader">
						<img src="<?php echo base_url(); ?>img/Images/download.svg" onclick="javascript:joinViaApp()"/>
					</div>
					<ul>
						<li class="helperCheck"><img src="<?php echo base_url(); ?>img/Images/checkmark.svg"/>&nbsp;&nbsp;
							Download and install it now
					...
					<form>
						...
						<div class="optionsParameters">
							...
							<p>
								...
								For more information visit the developer section of http://vidyo.io -->
								<label>Token</label>
								<input type="text" id="mediaBridged_token" class="token" placeholder="ACCESS-TOKEN" value="<?php echo $row->token; ?>">
							</p>
							<p>
								<!-- This is the display name that other users will see.
								-->
								<label for="displayName">Display Name</label>
								<input type="text" id="mediaBridged_displayName" class="displayName" placeholder="Display Name" value="<?php echo $this->session->userdata('username'); ?>">
							</p>
							<p>
								<!-- This is the "room" or "space" to which you're connecting
								the user. Other users who join this same Resource will be able to see and hear each other.
								-->
								<label for="resourceId">Resource ID</label>
								<input type="text" id="mediaBridged_resourceId" class="resourceId" placeholder="Conference Reference" value="<?php echo $row->room_id;} ?>">
							</p>
	...
	<div id="failed" class="hidden">
		<table>
			<tr>
				<td><img class="logo" src="<?php echo base_url(); ?>img/Images/VidyoIcon.png"/></td>
			</tr>
			<tr>
