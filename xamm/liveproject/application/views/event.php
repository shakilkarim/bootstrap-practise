...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="<?echo base_url() ;?>navbar-brand mr-1" href="index.html">LIVE EVENT </a>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            ...
            <a class="dropdown-item" href="<?php echo base_url(); ?>">Forgot Password</a>
            <div class="dropdown-divider"></div>
      ...
      <div id="content-wrapper">
        ...
        <div class="card-header">  <i class="fas fa-fw fa-plus"></i>
            <span>Create an event</span></div>
        <div class="card-body">
          <?php //echo validation_errors(); ?>
		  <?php echo form_open_multipart('user/eventform');?>
            ...
            <div class="form-group">
			 ...
			 <div class="form-group">
			   <label for="title">Location:</label>
                <input type="text" name="place" id="place" value="<?php echo set_value('place'); ?>" class="form-control"  >
				<span style=" color:red;"><?php echo form_error('place'); ?></span> 
            </div>
			 
			<div class="form-group">
			  <label for="startDate">Start date & time:</label>
			  <input type="datetime-local" name="startdate" id="startDate" value="<?php echo set_value('startdate'); ?>" class="form-control" >
				<span style=" color:red;"><?php echo form_error('startdate'); ?></span> 
			</div>
			<div class="form-group">
			<label for="endDate">End date & time:</label>
			  <input type="datetime-local" name="enddate" id="endDate" value="<?php echo set_value('enddate'); ?>" class="form-control"  >
				<span style=" color:red;"><?php echo form_error('enddate'); ?></span> 
			</div>
			
			<div class="form-group">
			<label for="sDescription">Short description:</label>
                <textarea rows="2" cols="5" name="sdescrip" id="sDescription" class="form-control"   ><?php echo set_value('sdescrip'); ?></textarea>
				<span style=" color:red;"><?php echo form_error('sdescrip'); ?></span>
            </div>
			<div class="form-group">
			<label for="lDescription">Long description:</label>
                <textarea rows="4" cols="5" name="ldescrip" id="lDescription" class="form-control"  ><?php echo set_value('ldescrip'); ?></textarea>
