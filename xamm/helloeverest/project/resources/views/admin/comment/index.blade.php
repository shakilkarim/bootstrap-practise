								...
								<div class="heading-area">
	                                ...
	                                <div class="action-list">
	                                    <select class="process select droplinks {{ $gs->is_comment == 1 ? 'drop-success' : 'drop-danger' }}">
	                                      <option data-val="1" value="{{route('admin-gs-iscomment',1)}}" {{ $gs->is_comment == 1 ? 'selected' : '' }}>Active</option>
	                                      <option data-val="0" value="{{route('admin-gs-iscomment',0)}}" {{ $gs->is_comment == 0 ? 'selected' : '' }}>Deactive</option>
	                                    </select>
	                                  </div>
								</div>
