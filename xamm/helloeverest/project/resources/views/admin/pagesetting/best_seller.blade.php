...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">Right Side Banner1 </h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-ps-best-seller') }}">Right Side Banner1 </a>
                        </li>
                      </ul>
                  </div>
                </div>
                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{ route('admin-ps-update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="best_seller_banner_link" placeholder="Link" required="" value="{{$data->best_seller_banner_link}}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="best_seller_banner_link1" placeholder="Link" required="" value="{{$data->best_seller_banner_link1}}">
                          </div>
                        </div>
