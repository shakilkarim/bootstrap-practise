          ...
          <div class="social-links-area">
            ...
            <form id="geniusform" action="{{ route('admin-ps-homeupdate') }}" method="POST"
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-2"></div>
                <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="small_banner">Top Small Banner *</label>
                  <label class="switch">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="flash_deal">Flash Deal *</label>
                  <label class="switch">
              ...
              <div class="row justify-content-center">
                <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="bottom_small">Bottom Small Banner *</label>
                  <label class="switch">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="partners">Partners *</label>
                  <label class="switch">
