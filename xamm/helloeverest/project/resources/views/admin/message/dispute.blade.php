  ...
  <div class="modal-header d-block text-center">
    <h4 class="modal-title d-inline-block">Confirm Delete</h4>
      ...
      <div class="modal-body">
            <p class="text-center">You are about to delete this Dispute. Every messages under this dispute will be deleted.</p>
                            ...
                            <div class="contact-form">
                                <form id="emailreply1">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <input type="text" class="input-field" id="order" name="order_number" placeholder="Order Numebr *" value="" required="">
                                        </li>
...
@section('scripts')
    ...
    var table = $('#geniustable').DataTable({
        ...
        $(".btn-area").append('<div class="col-sm-4 text-right">'+
          '<a class="add-btn" href="javascript:;" data-toggle="modal" data-target="#vendorform"><i class="fas fa-envelope"></i> Add Dispute</a>'+'</div>');
      });                       
