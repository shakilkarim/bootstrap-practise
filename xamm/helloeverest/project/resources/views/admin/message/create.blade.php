...
<div class="mr-breadcrumb">
    <div class="row">
        <div class="col-lg-12">
            ...
            <h4 class="heading">Order Number: {{$conv->order_number}}</h4>
            @endif
            <h4 class="heading">Conversation with {{$conv->user->name}} <a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> Back</a></h4>
                <ul class="links">
                    <li>
