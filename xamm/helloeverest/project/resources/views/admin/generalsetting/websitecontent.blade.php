                    ...
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                <h4 class="heading">Copyright Color *</h4>
                            </div>
                          </div>
                          <div class="col-lg-6">
                              <div class="form-group"> 
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->is_home== 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-ishome',1)}}" {{ $gs->is_home == 1 ? 'selected' : '' }}>Activated</option>
                                      <option data-val="0" value="{{route('admin-gs-ishome',0)}}" {{ $gs->is_home == 0 ? 'selected' : '' }}>Deactivated</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
