...
@section('content')
								...
								<div class="row">
									<div class="col-lg-12">
											...
											<ul class="links">
												...
												<li>
													<a href="{{ route('admin-generate-backup') }}">Generate BackUp </a>
												</li>
											</ul>
									</div>
								</div>
                        ...
                        @include('includes.admin.form-both')
												...
												<div class="add-product-footer text-center">
													<button name="addProduct_btn" id="generateBkup" type="button" class="addProductSubmit-btn">Generate Backup</button>
												</div>
