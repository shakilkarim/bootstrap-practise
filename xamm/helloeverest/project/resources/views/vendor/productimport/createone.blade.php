								...
								<div class="row">
									<div class="col-lg-12">
											...
											<li>
												...
												<li>
													<a href="{{ route('vendor-import-create') }}">Add Affiliate Product</a>
												</li>
											</ul>
									</div>
								</div>
					                      ...
					                      <form id="geniusform" action="{{route('vendor-import-store')}}" method="POST" enctype="multipart/form-data">
                        					...
                        					@include('includes.admin.form-both')
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="Enter Product Link" name="affiliate_link" required="">
				...
				<i class="icofont-upload-alt"></i> Upload Image Here
											  ...
											  <div id="f-link" style="display: none;">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="price" step="0.1" type="number" class="input-field" placeholder="e.g 20" required="" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="previous_price" step="0.1" type="number" class="input-field" placeholder="e.g 20" min="0">
													</div>
												</div>
