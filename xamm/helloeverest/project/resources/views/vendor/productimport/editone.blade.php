...
@section('content')
							...
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											...
											<li>
												<a href="{{ route('vendor-import-index') }}">All Products</a>
											</li>
												<li>
                        ...
                        @include('includes.admin.form-both')  
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="Enter Product Link" name="affiliate_link" required="" value="{{ $data->affiliate_link }}">
												...
												<div class="row">
													...
													<div class="col-lg-7">
															<select id="imageSource" name="image_source">
                                                  				<option value="file" {{ !filter_var($data->photo,FILTER_VALIDATE_URL) ? 'selected' : '' }}>File</option>
                                                  				<option value="link" {{ filter_var($data->photo,FILTER_VALIDATE_URL) ? 'selected' : '' }}>Link</option>
															</select>
													</div>
												</div>
				...
				<i class="icofont-upload-alt"></i> Upload Image Here
											  ...
											  <div id="f-link" {!! !filter_var($data->photo,FILTER_VALIDATE_URL) ? 'style="display:none"' : '' !!}>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="price" step="0.1" type="number" class="input-field" placeholder="e.g 20" value="{{round($data->price * $sign->value , 2)}}" required="" min="0">
													</div>
												</div>
